    ...
    <section>
      <div className="container pt-12 pb-20">
        <motion.h1
          ...
          className="text-2xl font-bold text-left pb-10 uppercase ms-5 sm:ms-0"
        >
          Our Menu
        </motion.h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {MenusData.map((menu) => (
            <motion.div
              ...
              className="bg-white rounded-2xl px-4 py-2 mx-10 sm:mx-0 shadow-[0_0_22px_0_rgba(0,0,0,0.15)] flex flex-row justify-around items-center gap-3"
            >
              <img
                src={menu.img}
                alt=""
